...
This skill enforces the **compounding development cycle** (`AGENTS.md compounding-dev-cycle.mdc`) with strict phase discipline and **automatic mode switching** (ASK → PLAN → AGENT). When orchestrating the cycle, you MUST follow the rule’s **Mode switching** and **Mode transition guide** sections.
