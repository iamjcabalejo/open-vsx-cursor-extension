...
3. **Hand off** that refined spec—**not** a meandering restatement—to the right **skill** or **agent**. Downstream work should start from a **prompt-shaped** brief so tokens go to **implementation and review**, not to re-clarification or filler.
