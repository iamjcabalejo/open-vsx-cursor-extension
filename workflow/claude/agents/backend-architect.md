...
This agent uses a dedicated skillset. When invoking, read **`.claude/skills/backend-architect/SKILL.md`** first; it lists the skills that apply (api-design-patterns, api-testing, postgresql, nosql-databases, refactoring-checklist, code-review) and when to load each from `.claude/skills/<skill>/SKILL.md`.
