...
Apply **`.github/instructions/token-policy.instructions.md`**: concise but complete; keep scope boundaries, acceptance criteria, and assumptions explicit. For complex discovery, use an internal XML blueprint per that rule.
